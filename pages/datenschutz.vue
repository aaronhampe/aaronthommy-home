<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-16">
    <div class="container mx-auto px-4">
      ...
      <!-- Content -->
      <div
        class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 md:p-8 mb-8"
      >
        <div class="prose prose-lg dark:prose-invert max-w-none">
          ...
          <p class="text-gray-600 dark:text-gray-300 mb-6">
            ...
            Speicherdauer genannt wurde, bleiben Ihre personenbezogenen Daten
          ...
          <p class="text-gray-600 dark:text-gray-300 mb-4">
            ...
            von besuchten Websites oder Domains enthalten und vom Browser auf
            dem Computer des Benutzers gespeichert werden. Ein Cookie dient in
            erster Linie dazu, die Informationen über einen Benutzer während
          ...
          <p class="text-gray-600 dark:text-gray-300 mb-4">
            Wenn Sie uns per Kontaktformular oder E-Mail kontaktieren, wird Ihre
          ...
          <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">
            Verwendung von Formspree für Kontaktanfragen
          </h3>
          <p class="text-gray-600 dark:text-gray-300 mb-4">
            Für unser Kontaktformular nutzen wir den Dienst Formspree. Wenn Sie
            das Kontaktformular ausfüllen und absenden, werden Ihre eingegebenen
            Daten (Name, E-Mail-Adresse, Betreff und Nachricht) an die Server
            von Formspree in den USA übermittelt und dort verarbeitet.
          </p>
          <p class="text-gray-600 dark:text-gray-300 mb-4">
            Formspree sammelt neben den von Ihnen eingegebenen Daten auch
            technische Informationen wie Ihre IP-Adresse, Browser-Typ und das
            Datum und die Uhrzeit der Übermittlung. Diese Daten werden von
            Formspree verwendet, um den Service zu betreiben, Missbrauch zu
            verhindern und die Qualität des Services zu verbessern.
          </p>
          <p class="text-gray-600 dark:text-gray-300 mb-6">
            Bitte beachten Sie, dass Formspree seinen Sitz in den USA hat und
            Daten dort unter Umständen nicht den gleichen Datenschutzstandards
            unterliegen wie in der Europäischen Union. Weitere Informationen zur
            Datenverarbeitung durch Formspree finden Sie in deren
            <a
          ...
          <p class="text-gray-600 dark:text-gray-300 mb-6">
            Die rechtliche Grundlage für die Übermittlung der Daten ist Ihre
            Einwilligung gemäß Art. 6 Abs. 1 lit. a DSGVO, die Sie durch
            Anklicken der Checkbox im Kontaktformular erteilen.
          </p>
          ...
          <p class="text-gray-600 dark:text-gray-300 mb-4">
            Wir unterhalten auf dieser Website verschiedene Social Media Profile
            und integrieren Elemente von Social Media Plattformen. Wenn Sie
            diese Profile besuchen oder die Plugins nutzen, können Daten an die
            jeweiligen Anbieter übertragen werden. Welche Daten erhoben werden
            und wie diese verwendet werden, finden Sie in den
